...
- **`~/.d0rc`** — your per-user config (registry URL, keybindings, etc.). Open it any time with `doc0 config edit`; see [Configuration](/docs/configuration) for the full schema.
