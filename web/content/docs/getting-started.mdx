...
```bash
doc0 mcp install              # interactive picker: Cursor, Claude Code, Windsurf, Antigravity, Zed, OpenCode
...
See [MCP](/docs/mcp) for the tool schema, every install flag, and installed-only mode.
